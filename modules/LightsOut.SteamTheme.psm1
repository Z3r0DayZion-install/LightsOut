...
function Reset-SteamHeroExtras {
    ...
    if ($script:lblHeroTitle) {
        ...
        $script:lblHeroTitle.Size = New-Object System.Drawing.Size(($script:pnlSteamHero.Width - 24), 20)
    }
}
...
function Add-SteamHeroPanel {
    ...
    $script:pnlSteamHero.Size = New-Object System.Drawing.Size($Width, 52)
    ...
    $script:pnlSteamHero.Add_Paint({
        ...
        $g.DrawRectangle($outer, 1, 1, $script:pnlSteamHero.Width - 3, $script:pnlSteamHero.Height - 3)
        $outer.Dispose()
        $pen = New-Object System.Drawing.Pen $border
        $g.DrawRectangle($pen, 0, 0, $script:pnlSteamHero.Width - 1, $script:pnlSteamHero.Height - 1)
        $pen.Dispose()
        $accent = New-Object System.Drawing.Pen (Get-SteamUiColor 'Section' ([System.Drawing.Color]::FromArgb(102, 192, 244))), 3
        $g.DrawLine($accent, 0, 0, 0, $script:pnlSteamHero.Height)
        $accent.Dispose()
    })
    ...
    $script:lblHeroTitle.Size = New-Object System.Drawing.Size($Width - 24, 20)
    $script:lblHeroTitle.Font = New-Object System.Drawing.Font('Segoe UI', 11, [System.Drawing.FontStyle]::Bold)
    ...
    $script:lblHeroTag.Location = New-Object System.Drawing.Point(12, 28)
    $script:lblHeroTag.Size = New-Object System.Drawing.Size($Width - 24, 18)
    ...
    $script:lblHeroDetail.Location = New-Object System.Drawing.Point(12, 44)
    $script:lblHeroDetail.Size = New-Object System.Drawing.Size($Width - 24, 18)
    ...
    $script:lblHeroStatLine.Location = New-Object System.Drawing.Point(12, 34)
    $script:lblHeroStatLine.Size = New-Object System.Drawing.Size($Width - 88, 16)
    ...
    $script:lblHeroDone.Location = New-Object System.Drawing.Point(($Width - 62), 30)
    $script:lblHeroDone.Size = New-Object System.Drawing.Size(50, 18)
    ...
    $script:lblHeroDone.BackColor = [System.Drawing.Color]::FromArgb(24, 48, 32)
    ...
    $script:lblHeroEncourage.Location = New-Object System.Drawing.Point(12, 52)
    $script:lblHeroEncourage.Size = New-Object System.Drawing.Size($Width - 24, 16)
...
function Add-SteamFormChrome {
    ...
    $script:SteamNavBtns = @{}
    foreach ($nav in @(
        @{ Id = 'library'; Label = 'LIB'; Tip = 'Rituals & countdown' }
        @{ Id = 'schedule'; Label = 'SCH'; Tip = 'Tonight, clock & calendar' }
        @{ Id = 'settings'; Label = 'SET'; Tip = 'Power actions & options' }
    )) {
        $nb = New-Object System.Windows.Forms.Button
        $nb.Text = $nav.Label
        $nb.Size = New-Object System.Drawing.Size(46, 40)
    ...
    $brandW = [math]::Max(180, ($hdr.Width - 140))
    $brandX = [int](($hdr.Width - $brandW) / 2)

    $script:lblSteamBrand = New-Object System.Windows.Forms.Label
    $script:lblSteamBrand.Text = 'Lights Out PC'
    ...
    $script:lblSteamBrandSub.Text = 'Bedtime Mode for Windows'
    ...
    if ($AppVersion) {
        ...
        $script:lblSteamVer.Location = New-Object System.Drawing.Point(($hdr.Width - 118), 10)
    ...
    $script:lnkSteamStats.Location = New-Object System.Drawing.Point(($hdr.Width - 168), 9)
    ...
    $lblUser.Location = New-Object System.Drawing.Point(($hdr.Width - 52), 8)
    $lblUser.Size = New-Object System.Drawing.Size(44, 18)
    $lblUser.TextAlign = 'TopRight'
    $lblUser.Font = New-Object System.Drawing.Font('Segoe UI', 8)
    $lblUser.ForeColor = Get-SteamUiColor 'Muted' ([System.Drawing.Color]::FromArgb(139, 152, 165))
    $lblUser.BackColor = Get-SteamUiColor 'Header' ([System.Drawing.Color]::FromArgb(23, 26, 33))
...
function Add-SteamSleepClearancePanel {
    ...
    $script:pnlSleepClearance.Size = New-Object System.Drawing.Size($Width, 34)
    ...
    $script:lblClearanceSub.Location = New-Object System.Drawing.Point(10, 18)
...
function Update-SteamTonightPreviewHero {
    ...
    if ($script:lblHeroTitle) {
        ...
        $script:lblHeroTitle.Location = New-Object System.Drawing.Point(12, 22)
        $script:lblHeroTitle.Size = New-Object System.Drawing.Size(($script:pnlSteamHero.Width - 196), 22)
    ...
    if ($script:lblHeroDetail) {
        $script:lblHeroDetail.Location = New-Object System.Drawing.Point(12, 46)
...
function Add-SteamTrustBadgesPanel {
    ...
    $script:pnlTrustBadges.Location = New-Object System.Drawing.Point(24, $Y)
    $script:pnlTrustBadges.Size = New-Object System.Drawing.Size($Width, 42)
    ...
    for ($i = 0; $i -lt 5; $i++) {
        ...
        $title.Location = New-Object System.Drawing.Point(4, 4)
        $title.Size = New-Object System.Drawing.Size(72, 12)
        ...
        $sub.Location = New-Object System.Drawing.Point(4, 16)
        $sub.Size = New-Object System.Drawing.Size(72, 22)
        $sub.Font = New-Object System.Drawing.Font('Segoe UI', 6)
...
function Update-SteamTrustBadgesPanel {
    ...
    $defs.Add(@{ T = 'FINAL CONFIRM ON'; S = 'You confirm before it runs'; W = $false })
    $defs.Add(@{ T = 'EMERGENCY CANCEL'; S = 'Instantly stop at any time'; W = $true })
    $defs.Add(@{ T = 'NO CLOUD'; S = 'No accounts. No tracking.'; W = $false })

    $show = @($defs | Select-Object -First 5)
    $gap = 4
    $cardW = [math]::Max(72, [int](($script:pnlTrustBadges.Width - ($gap * ($show.Count - 1))) / [math]::Max(1, $show.Count)))
    $x = 0
    for ($i = 0; $i -lt $script:SteamTrustCards.Count; $i++) {
        ...
        if ($i -lt $show.Count) {
            ...
            $card.Size = New-Object System.Drawing.Size($cardW, 40)
            $title.Width = ($cardW - 8)
            $sub.Width = ($cardW - 8)
            $card.Visible = $true
            $x += ($cardW + $gap)
...
function Update-SteamMorningProofHero {
    ...
    $script:lblHeroTitle.Location = New-Object System.Drawing.Point(12, 8)
    $script:lblHeroTitle.Size = New-Object System.Drawing.Size(($script:pnlSteamHero.Width - 24), 24)
